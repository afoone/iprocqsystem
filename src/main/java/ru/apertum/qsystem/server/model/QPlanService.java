...
public class QPlanService implements Serializable {
    ...
    private Boolean flexible_invitation = false;

    @Column(name = "flexible_invitation", insertable = true, updatable = true)
    public Boolean getFlexible_invitation() {
        return flexible_invitation;
    }

    public void setFlexible_invitation(Boolean flexible_invitation) {
        this.flexible_invitation = flexible_invitation;
    }
    ...
    public String toString() {
        return (getFlexible_coef() ? "* " : "") + (getFlexible_invitation()? "(F)" : "") + "[" + Uses.get_COEFF_WORD().get(getCoefficient()) + "]" + service.getPrefix() + " " + service.getName();
    }
    //******************************************************************************************************************
    //*******            Статистика             *******************************************
    //******************************************************************************************************************
