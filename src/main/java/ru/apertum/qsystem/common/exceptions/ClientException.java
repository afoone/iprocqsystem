...
public class ClientException extends ServerException {
    ...
    private final String clientMsg = Locales.locMes("client_exception");

    public ClientException(String textException) {
        super(textException);
        JOptionPane.showMessageDialog(null, textException, clientMsg, JOptionPane.ERROR_MESSAGE);
    }

    public ClientException(String textException, Exception ex) {
        super(textException, ex);
        JOptionPane.showMessageDialog(null, textException + ex, clientMsg, JOptionPane.ERROR_MESSAGE);
    }

    public ClientException(Exception ex) {
        super(ex);
        JOptionPane.showMessageDialog(null, ex, clientMsg, JOptionPane.ERROR_MESSAGE);
    }
}
