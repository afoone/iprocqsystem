...
public final class Locales {
    ...
    public final SimpleDateFormat format_for_label2_short;
    public final SimpleDateFormat format_for_print;
    public final SimpleDateFormat format_for_print_short;
    ...
    public final SimpleDateFormat format_dd_MM_yyyy;
    ...
    private Locales() {
        ...
        switch (getLangCurrent().toString().toLowerCase(Locale.US)) {
            ...
            case "az_az":
                ...
                break;
            case "hy_am":
                symbols.setMonths(Uses.ARMENIAN_MONAT);
                break;
        }
        ...
        format_for_label2_short = new SimpleDateFormat("dd.MM HH.mm:ss", symbols);
        format_for_print = new SimpleDateFormat("dd MMMM HH:mm", symbols);
        format_for_print_short = new SimpleDateFormat("dd.MM HH:mm", symbols);
        ...
        format_dd_MM_yyyy = new SimpleDateFormat(DATE_FORMAT_FULL_SHORT, symbols);
    }
