...
public class KeyboardQwertyRus extends javax.swing.JPanel {
    ...
    private transient KeyPressEvent keyPressEvent;
    ...
    public KeyboardQwertyRus() {
        initComponents();
        keyFont = new Font("Arial", 2, 29);
        foregraundColor = Color.BLACK;
        setFont(keyFont, foregraundColor);
        setRegim(regim);
    }
    ...
    private void initComponents() {
        ...
        jButton26.addActionListener(evt -> buttonClick(evt));
        ...
        jButton27.addActionListener(evt -> buttonClick(evt));
        ...
        jButton29.addActionListener(evt -> buttonClick(evt));
        ...
        jButton30.addActionListener(evt -> buttonClick(evt));
        ...
        jButton31.addActionListener(evt -> buttonClick(evt));
        ...
        jButton33.addActionListener(evt -> buttonClick(evt));
