...
public class FBreaksChangeDialog extends javax.swing.JDialog {
    ...
    private void loadBreaks(QBreak[] breaks) {
        ...
        list.addListSelectionListener((ListSelectionEvent e) -> {
            if (list.getSelectedValue() != null) {
                ...
                gc.setTime(qbreak.getFrom_time());
    ...
    public void addBreak() {
        ...
        if (d1.before(gc.getTime())) {
            breaks = (QBreak[]) ArrayUtils.add(breaks, new QBreak(d1, gc.getTime(), tpHint.getText(), breaksParent));
            loadBreaks(breaks);
        } else {
            JOptionPane.showConfirmDialog(this, locMes("add_break_dialog.err1.message"), locMes("add_break_dialog.err1.title"), JOptionPane.DEFAULT_OPTION, JOptionPane.ERROR_MESSAGE);
        }
