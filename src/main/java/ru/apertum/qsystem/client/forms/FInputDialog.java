...
public class FInputDialog extends javax.swing.JDialog {
    ...
    public static String showInputDialog(Frame parent, boolean modal, INetProperty netProperty, boolean fullscreen, int delay, String caption) {
        ...
        result = "";
        inputDialog.setSize(FWelcome.getScreenHorizontal(), FWelcome.getScreenVertical());
        ...
        if (!(QConfig.cfg().isDebug() || QConfig.cfg().isDemo() && !fullscreen)) {
            ...
            inputDialog.setSize(FWelcome.getScreenHorizontal(), FWelcome.getScreenVertical());
            Uses.setLocation(inputDialog, parent);
        }
    ...
    final private transient org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(ru.apertum.qsystem.QSystem.class).getContext().getResourceMap(FInputDialog.class);
