...
private void buttonMainActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonMainActionPerformed
    FParamsEditor.changeParams(this.parentFarame, true, mainElement, getLocaleMessage("cfg.params.main"));
...
private void buttonRightActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonRightActionPerformed
    FBoardParams.changeParams(this.parentFarame, rightElement, getLocaleMessage("cfg.params.right"), netProperty);
}//GEN-LAST:event_buttonRightActionPerformed

private void buttonDownActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonDownActionPerformed
    FBoardParams.changeParams(this.parentFarame, bottomElement, getLocaleMessage("cfg.params.bottom"), netProperty);
}//GEN-LAST:event_buttonDownActionPerformed

private void buttonLeftActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonLeftActionPerformed
    FBoardParams.changeParams(this.parentFarame, leftElement, getLocaleMessage("cfg.params.left"), netProperty);
...
private void buttonTopActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonTopActionPerformed
    FBoardParams.changeParams(this.parentFarame, topElement, getLocaleMessage("cfg.params.top"), netProperty);
    ...
    private void buttonDown2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonDown2ActionPerformed
        FBoardParams.changeParams(this.parentFarame, bottomElement2, getLocaleMessage("cfg.params.bottom2"), netProperty);
