...
public class FServiceChangeDialod extends javax.swing.JDialog {
    ...
    private void init() {
        ...
        labelSpecPlugin.setVisible(false);
        tfSpecPlugin.setVisible(false);
        cbLangPlugin.setVisible(false);
    }
    ...
    private void loadService(QService service) {
        ...
        spDataAsNumber.setValue(service.getInputedAsNumber());
        ...
        tfSpecPlugin.setText("");
        cbLangPlugin.setSelected(false);
        final String[] parts = service.getSoundTemplate() == null ? null : service.getSoundTemplate().split("#");
        cbSound.setSelected(parts == null || parts.length == 0 ? false : (parts[0].startsWith("1")));
        if (parts != null) {
            if (parts[0].length() > 1) {
            ...
            if (parts[0].length() > 2) {
                cbClient.setSelected("1".equals(parts[0].substring(2, 3)));
            }
            if (parts[0].length() > 3) {
                cbClientNumber.setSelected("1".equals(parts[0].substring(3, 4)));
            }
            if (parts[0].length() > 4) {
            ...
            if (parts[0].length() > 5) {
                cbGoNumber.setSelected(parts[0].endsWith("1"));
            }

            if (parts.length > 1) {
                tfSpecPlugin.setText(parts[1]);
            } else {
                tfSpecPlugin.setText("");
            }
            if (parts.length > 2) {
                cbLangPlugin.setSelected("1".equals(parts[2]));
            } else {
                cbLangPlugin.setSelected(false);
            }
        }
    ...
    private void saveService() {
        ...
        if (!f.isEmpty() && JOptionPane.showConfirmDialog(null, getLocaleMessage("dialog.message5"), getLocaleMessage("confirm"), JOptionPane.OK_CANCEL_OPTION) == JOptionPane.CANCEL_OPTION) {
        ...
        service.setInputedAsNumber((Integer) spDataAsNumber.getValue());
        ...
        final String tmpl = (cbSound.isSelected() ? "1" : "0")
                ...
                + "#" + tfSpecPlugin.getText().split("\\.")[0] + "#" + (cbLangPlugin.isSelected() ? "1" : "0");
    ...
    private void initComponents() {
        ...
        spDataAsNumber = new javax.swing.JSpinner();
        ...
        tfSpecPlugin = new javax.swing.JTextField();
        labelSpecPlugin = new javax.swing.JLabel();
        cbLangPlugin = new javax.swing.JCheckBox();
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance().getContext().getResourceMap(FServiceChangeDialod.class);
        ...
        comboBoxEnabled.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Активна", "Неактивна", "Невидима", "Только предварительная запись", "Заглушка", "Нет предварительной записи", "Рулон талонов" }));
        comboBoxEnabled.setName("comboBoxEnabled"); // NOI18N
        comboBoxEnabled.setModel(new javax.swing.DefaultComboBoxModel(new String[] { getLocaleMessage("active"), getLocaleMessage("notActive"), getLocaleMessage("invisible"), getLocaleMessage("forPrereg"), getLocaleMessage("forDummy"), getLocaleMessage("noPrereg"), getLocaleMessage("roll") }));
        ...
        cbRequaredAsColumnExt.setText(resourceMap.getString("cbRequaredAsColumnExt.text")); // NOI18N
        ...
        spDataAsNumber.setModel(new javax.swing.SpinnerNumberModel(0, 0, 15, 1));
        spDataAsNumber.setName("spDataAsNumber"); // NOI18N
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(comboBoxCalendar, 0, 727, Short.MAX_VALUE))
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        .addComponent(jLabel10)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(textFieldTicketText, javax.swing.GroupLayout.DEFAULT_SIZE, 700, Short.MAX_VALUE))
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        .addComponent(jLabel3)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(comboBoxSchedule, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel3Layout.createSequentialGroup()
                            ...
                            .addGroup(jPanel3Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(jPanel3Layout.createSequentialGroup()
                                        ...
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                        .addComponent(spDataAsNumber, javax.swing.GroupLayout.PREFERRED_SIZE, 40, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel29)
                    .addComponent(spDataAsNumber, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel30))
                .addGap(18, 18, 18)
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(WysiwygButton, javax.swing.GroupLayout.PREFERRED_SIZE, 120, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(0, 0, Short.MAX_VALUE))
                    .addComponent(jSplitPane2, javax.swing.GroupLayout.DEFAULT_SIZE, 674, Short.MAX_VALUE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(butWYS2, javax.swing.GroupLayout.PREFERRED_SIZE, 123, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        ...
        jPanel5Layout.setVerticalGroup(
            ...
            .addGroup(jPanel5Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(jSplitPane3, javax.swing.GroupLayout.DEFAULT_SIZE, 407, Short.MAX_VALUE)
                .addContainerGap())
        );
        ...
        tfSpecPlugin.setText(resourceMap.getString("tfSpecPlugin.text")); // NOI18N
        tfSpecPlugin.setName("tfSpecPlugin"); // NOI18N

        labelSpecPlugin.setText(resourceMap.getString("labelSpecPlugin.text")); // NOI18N
        labelSpecPlugin.setName("labelSpecPlugin"); // NOI18N

        cbLangPlugin.setText(resourceMap.getString("cbLangPlugin.text")); // NOI18N
        cbLangPlugin.setName("cbLangPlugin"); // NOI18N
            ...
            .addGroup(jPanel7Layout.createSequentialGroup()
                ...
                .addGroup(jPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel7Layout.createSequentialGroup()
                        .addGap(10, 10, 10)
                        .addGroup(jPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(cbLangPlugin)
                            .addGroup(jPanel7Layout.createSequentialGroup()
                                .addComponent(labelSpecPlugin)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(tfSpecPlugin, javax.swing.GroupLayout.PREFERRED_SIZE, 241, javax.swing.GroupLayout.PREFERRED_SIZE)))
                        .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))))
        );
        jPanel7Layout.setVerticalGroup(
            ...
            .addGroup(jPanel7Layout.createSequentialGroup()
                ...
                .addGroup(jPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(tfSpecPlugin, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(labelSpecPlugin))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(cbLangPlugin)
        ...
        tfID.setFont(resourceMap.getFont("tfID.font")); // NOI18N
            ...
            .addGroup(panelPropsLayout.createSequentialGroup()
                ...
                .addGroup(panelPropsLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(panelPropsLayout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(panelTreeCmbx, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jButton1))
                    .addGroup(panelPropsLayout.createSequentialGroup()
                        .addGroup(panelPropsLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addGroup(panelPropsLayout.createSequentialGroup()
    ...
    private void checkBoxInputRequiredStateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_checkBoxInputRequiredStateChanged
        ...
        spDataAsNumber.setEnabled(checkBoxInputRequired.isSelected());
    ...
    private javax.swing.JCheckBox cbLangPlugin;
    ...
    private javax.swing.JLabel labelSpecPlugin;
    ...
    private javax.swing.JSpinner spDataAsNumber;
    ...
    private javax.swing.JTextField tfSpecPlugin;
