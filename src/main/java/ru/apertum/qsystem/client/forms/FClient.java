...
public final class FClient extends javax.swing.JFrame {
    ...
    public FClient(QUser user, final IClientNetProperty netProperty) throws AWTException {
        ...
        tray = QTray.getInstance(QConfig.cfg().doNotUseTray() ? new JFrame() : fr, "/ru/apertum/qsystem/client/forms/resources/client.png", getLocaleMessage("messages.tray.hint"));
    ...
    private class PlanTreeNode extends DefaultMutableTreeNode {

        final public transient SelfService serv;
        final public String people;
    ...
    private void initComponents() {
        ...
        popupClients = new javax.swing.JPopupMenu();
        miFlexInvitation = new javax.swing.JMenuItem();
        ...
        popupClients.setName("popupClients"); // NOI18N
        popupClients.addPopupMenuListener(new javax.swing.event.PopupMenuListener() {
            ...
            public void popupMenuWillBecomeVisible(javax.swing.event.PopupMenuEvent evt) {
                popupClientsPopupMenuWillBecomeVisible(evt);
            }
        });

        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance().getContext().getResourceMap(FClient.class);
        miFlexInvitation.setText(resourceMap.getString("miFlexInvitation.text")); // NOI18N
        miFlexInvitation.setName("miFlexInvitation"); // NOI18N
        miFlexInvitation.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                miFlexInvitationActionPerformed(evt);
            }
        });
        ...
        jPanel5Layout.setHorizontalGroup(
                jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addComponent(jScrollPane6, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 418, Short.MAX_VALUE)
        );
        ...
        panelDownLayout.setHorizontalGroup(
                panelDownLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        ...
                        .addComponent(jSplitPane1, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 676, Short.MAX_VALUE)
        );
        ...
        setSize(new java.awt.Dimension(1072, 655));
    ...
    private void miFlexInvitationActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_miFlexInvitationActionPerformed
        ...
        if (selectedPath != null && selectedPath.getLastPathComponent() instanceof PlanTreeNode) {
            ...
            if (node.serv.isFlexyInvitation() && (getKeys_current().equals(FClient.KEYS_MAY_INVITE) || getKeys_current().equals(FClient.KEYS_OFF))) {
    ...
    private void inviteFlexCustomer(PlanTreeNode node) {
        try {
            ...
            setSituation(NetCommander.getSelfServices(netProperty, user.getId()));
            // поддержка расширяемости плагинами
            extPluginIStartClientPressButton(user, netProperty, getUserPlan(), new ActionEvent(node, 1, "inviteFlexCustomer"), 1);
            end(lastInvite);
        } catch (HeadlessException | QException th) {
            throw new ClientException(new Exception(th));
        }
    ...
    public static void main(String args[]) throws DocumentException {
        QLog.initial(args, QModule.client);
