...
public class FPreInfoDialog extends javax.swing.JDialog {
    ...
    public static boolean showPreInfoDialog(Frame parent, String htmlText, String printText, boolean modal, boolean fullscreen, int delay) {
        ...
        return showPreInfoDialog(parent, htmlText, printText, modal, fullscreen, delay, true);
    }

    public static boolean showPreInfoDialog(Frame parent, String htmlText, String printText, boolean modal, boolean fullscreen, int delay, boolean mayCancel) {
        if (htmlText == null || htmlText.isEmpty()) {
            return true;
        }
        ...
        if (!(QConfig.cfg().isDebug() || QConfig.cfg().isDemo() && !fullscreen)) {
            ...
            preInfoDialog.setSize(FWelcome.getScreenHorizontal(), FWelcome.getScreenVertical());
            Uses.setLocation(preInfoDialog, parent);
        }
        preInfoDialog.buttonInRoot.setVisible(printText != null && !printText.isEmpty());
        preInfoDialog.jButton2.setVisible(mayCancel);
