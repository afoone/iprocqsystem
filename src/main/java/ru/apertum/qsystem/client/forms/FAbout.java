...
public final class FAbout extends javax.swing.JDialog {
    ...
    public static void loadVersionSt() {
        ...
        try (final InputStream inStream = new String().getClass().getResourceAsStream("/ru/apertum/qsystem/common/version.properties")) {
        ...
        BUILD_ = settings.getProperty(BUILD);
    ...
    private void loadVersion() {
        ...
        labelVersion.setText(getLocaleMessage("about.version") + " : " + VERSION_ + "_" + BUILD_);
    }
