...
public class DistributionWaitDayServices extends AFormirovator {
    ...
    public Response getDialog(String driverClassName, String url, String username, String password, HttpRequest request, String errorMessage) {
        ...
        try {
            result.setData(new String(result.getData(), "UTF-8").replaceFirst("#DATA_FOR_TITLE#", "Distribución del tiempo medio de espera en un día para un servicio:").replaceFirst("#DATA_FOR_SERVICES#", services_select.toString()).getBytes("UTF-8"));
