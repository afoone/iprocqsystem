...
public class RatioServices extends AFormirovator {
     ...
     * Для параметров
     */
    private final HashMap<String, Date> paramMap = new HashMap<>();
    ...
    public Response getDialog(String driverClassName, String url, String username, String password, HttpRequest request, String errorMessage) {
        return getDialog("/ru/apertum/qsystem/reports/web/get_period_for_ratio_services.html", request, errorMessage);
    }
