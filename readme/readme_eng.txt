...
QMS QSystem already has built-in database H2. For H2 do not need install any software before using. You can start admin app right after installation QSystem.
In case MySQL you must install it before and create database by script qsystem_eng.sql.
