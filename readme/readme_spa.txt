...
QSystem ya se ha incorporado en la base de datos de H2. Para el H2 no es necesario instalar ningún software antes de usar. Puede comenzar justo después de aplicación de administración del sistema de instalación.
En el caso de MySQL debe instalarlo antes de crear la base de datos y por qsystem_eng.sql guión.
