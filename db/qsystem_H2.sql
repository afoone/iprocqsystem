...
CREATE TABLE IF NOT EXISTS `services` (
  ...
  `inputed_as_ext` TINYINT(1) NOT NULL DEFAULT false COMMENT 'Разрешение выводить введенные данные в третью колонку на табло и в панель вызова',
...
CREATE INDEX `fk_services_services1_idx` ON `services` (`link_service_id` ASC);
...
CREATE UNIQUE INDEX `idx_auth_id_UNIQUE` ON `clients_authorization` (`auth_id` ASC);
...
CREATE TABLE IF NOT EXISTS `services_users` (
  ...
  `flexible_invitation` TINYINT(1) NOT NULL DEFAULT 0 COMMENT 'возможность вызывать из людей к услуге а не автоматом ото всюду',
  PRIMARY KEY (`id`),
...
CREATE INDEX `idx_responses_responses` ON `responses` (`parent_id` ASC);
...
CREATE TABLE IF NOT EXISTS `break` (
  ...
  `hint` VARCHAR(1024) NULL COMMENT 'Текст Html подсказки при получении талона во время перерыва',
  PRIMARY KEY (`id`),
...
INSERT INTO `services` (`id`, `name`, `description`, `service_prefix`, `button_text`, `status`, `enable`, `prent_id`, `day_limit`, `person_day_limit`, `advance_limit`, `advance_limit_period`, `advance_time_period`, `schedule_id`, `input_required`, `input_caption`, `result_required`, `calendar_id`, `pre_info_html`, `pre_info_print_text`, `point`, `ticket_text`, `tablo_text`, `seq_id`, `but_x`, `but_y`, `but_b`, `but_h`, `deleted`, `duration`, `sound_template`, `expectation`, `link_service_id`, `inputed_as_ext`, `inputed_as_number`) VALUES (1, 'Дерево услуг', 'Дерево услуг', '-', '<html><p align=center><span style="font-size:55.0;color:#DC143C">Система управления очередью</span><br><span style="font-size:45.0;color:#DC143C"><i>выберите требуемую услугу</i>', 1, 1, NULL, 0, 0, 1, 14, 60, NULL, 0, '', 0, NULL, '', '', 0, NULL, '', 0, 100, 100, 200, 100, NULL, 1, '120050', 0, NULL, false, 0);
INSERT INTO `services` (`id`, `name`, `description`, `service_prefix`, `button_text`, `status`, `enable`, `prent_id`, `day_limit`, `person_day_limit`, `advance_limit`, `advance_limit_period`, `advance_time_period`, `schedule_id`, `input_required`, `input_caption`, `result_required`, `calendar_id`, `pre_info_html`, `pre_info_print_text`, `point`, `ticket_text`, `tablo_text`, `seq_id`, `but_x`, `but_y`, `but_b`, `but_h`, `deleted`, `duration`, `sound_template`, `expectation`, `link_service_id`, `inputed_as_ext`, `inputed_as_number`) VALUES (2, 'Услуга', 'Описание услуги', 'А', '<html><b><p align=center><span style="font-size:20.0pt;color:blue">Некая услуга', 1, 1, 1, 0, 0, 1, 14, 60, 1, 0, '', 0, 1, '', '', 0, NULL, '', 0, 100, 100, 200, 100, NULL, 1, '021111', 0, NULL, false, 0);
...
INSERT INTO `users` (`id`, `name`, `password`, `point`, `adress_rs`, `enable`, `admin_access`, `report_access`, `parallel_access`, `point_ext`, `tablo_text`, `deleted`) VALUES (1, 'Администратор', '', '1', 32, 1, 1, 1, DEFAULT, '', '', NULL);
INSERT INTO `users` (`id`, `name`, `password`, `point`, `adress_rs`, `enable`, `admin_access`, `report_access`, `parallel_access`, `point_ext`, `tablo_text`, `deleted`) VALUES (2, 'Пользователь', '', '2', 33, 1, 0, 0, DEFAULT, '<html><span style="font-size:26.0pt;color:blue">Этаж 1<br>Кабинет 1 #user #service #inputed', '', NULL);
...
INSERT INTO `services_users` (`id`, `service_id`, `user_id`, `coefficient`, `flexible_coef`, `flexible_invitation`) VALUES (1, 2, 2, 1, 0, 0);
...
INSERT INTO `responses` (`id`, `parent_id`, `name`, `text`, `input_caption`, `input_required`, `deleted`) VALUES (0, NULL, 'Отзывы посетителей', '<html><p  style=\"text-align: center;\"><font size=\"10\" color=\"#ffff4d\">Помогите нам улучшить нашу работую</font><br><font  size=\"4\" color=\"#ffff4d\">Каждый ваш отзыв очень важен для нас.</font></p>', DEFAULT, DEFAULT, NULL);
INSERT INTO `responses` (`id`, `parent_id`, `name`, `text`, `input_caption`, `input_required`, `deleted`) VALUES (1, 0, 'Отлично', '<html><b><p align=center><span style="font-size:20.0pt;color:green">Отлично</span></b>', DEFAULT, DEFAULT, NULL);
INSERT INTO `responses` (`id`, `parent_id`, `name`, `text`, `input_caption`, `input_required`, `deleted`) VALUES (2, 0, 'Хорошо', '<html><b><p align=center><span style="font-size:20.0pt;color:green">Хорошо</span></b>', DEFAULT, DEFAULT, NULL);
INSERT INTO `responses` (`id`, `parent_id`, `name`, `text`, `input_caption`, `input_required`, `deleted`) VALUES (3, 0, 'Удовлетворительно', '<html><b><p align=center><span style="font-size:20.0pt;color:green">Удовлетворительно</span></b>', DEFAULT, DEFAULT, NULL);
INSERT INTO `responses` (`id`, `parent_id`, `name`, `text`, `input_caption`, `input_required`, `deleted`) VALUES (4, 0, 'Плохо', '<html><b><p align=center><span style="font-size:20.0pt;color:green">Плохо</span></b>', DEFAULT, DEFAULT, NULL);
INSERT INTO `responses` (`id`, `parent_id`, `name`, `text`, `input_caption`, `input_required`, `deleted`) VALUES (5, 0, 'Отвратительно', '<html><b><p align=center><span style="font-size:20.0pt;color:green">Отвратительно</span></b>', DEFAULT, DEFAULT, NULL);
