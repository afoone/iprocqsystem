...
-- Fri Feb 23 14:11:40 2018
-- Model: QSystem for MySQL    Version: 4
...
CREATE INDEX `fk_services_services1_idx` ON `qsystem`.`services` (`link_service_id` ASC);
...
-- -----------------------------------------------------
-- Table `qsystem`.`spec_schedule`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `qsystem`.`spec_schedule` ;
...
CREATE INDEX `idx_spec_schedule_calendar` ON `qsystem`.`spec_schedule` (`calendar_id` ASC);

CREATE INDEX `idx_spec_schedule_schedule` ON `qsystem`.`spec_schedule` (`schedule_id` ASC);
...
CREATE TABLE IF NOT EXISTS `qsystem`.`properties` (
  ...
  PRIMARY KEY (`id`))
ENGINE = InnoDB
COMMENT = 'Системные настройки и параметры';
...
START TRANSACTION;
USE `qsystem`;
INSERT INTO `qsystem`.`users` (`id`, `name`, `password`, `point`, `adress_rs`, `enable`, `admin_access`, `report_access`, `parallel_access`, `point_ext`, `tablo_text`, `deleted`) VALUES (1, 'Администратор', '', '1', 32, 1, 1, 1, DEFAULT, '', '', NULL);
INSERT INTO `qsystem`.`users` (`id`, `name`, `password`, `point`, `adress_rs`, `enable`, `admin_access`, `report_access`, `parallel_access`, `point_ext`, `tablo_text`, `deleted`) VALUES (2, 'Пользователь', '', '2', 33, 1, 0, 0, DEFAULT, '<html><span style=\'font-size:26.0pt;color:blue\'>Этаж 1<br>Кабинет 1 #user #service #inputed', '', NULL);
...
INSERT INTO `qsystem`.`responses` (`id`, `parent_id`, `name`, `text`, `input_caption`, `input_required`, `deleted`) VALUES (1, 0, 'Отлично', '<html><b><p align=center><span style=\'font-size:20.0pt;color:green\'>Отлично</span></b>', DEFAULT, DEFAULT, NULL);
INSERT INTO `qsystem`.`responses` (`id`, `parent_id`, `name`, `text`, `input_caption`, `input_required`, `deleted`) VALUES (2, 0, 'Хорошо', '<html><b><p align=center><span style=\'font-size:20.0pt;color:green\'>Хорошо</span></b>', DEFAULT, DEFAULT, NULL);
INSERT INTO `qsystem`.`responses` (`id`, `parent_id`, `name`, `text`, `input_caption`, `input_required`, `deleted`) VALUES (3, 0, 'Удовлетворительно', '<html><b><p align=center><span style=\'font-size:20.0pt;color:green\'>Удовлетворительно</span></b>', DEFAULT, DEFAULT, NULL);
INSERT INTO `qsystem`.`responses` (`id`, `parent_id`, `name`, `text`, `input_caption`, `input_required`, `deleted`) VALUES (4, 0, 'Плохо', '<html><b><p align=center><span style=\'font-size:20.0pt;color:green\'>Плохо</span></b>', DEFAULT, DEFAULT, NULL);
INSERT INTO `qsystem`.`responses` (`id`, `parent_id`, `name`, `text`, `input_caption`, `input_required`, `deleted`) VALUES (5, 0, 'Отвратительно', '<html><b><p align=center><span style=\'font-size:20.0pt;color:green\'>Отвратительно</span></b>', DEFAULT, DEFAULT, NULL);
